		...
		<div class="container">
			...
			<div class="row">
				...
				<?php
					...
					$hsl_a = file_get_contents("https://www.metaweather.com/api/location/$woeid");
					...
					foreach($hsl as $innerArray){
						...
						//echo $innerArray2['applicable_date']."<br>";
				?>
					<div  style="opacity:0.8" class="col-md-3">
						...
						<h3 style="color:white;"><?php echo $innerArray2['weather_state_name']; ?></h3>
							<img style="color:white;" height="42" width="42" src="https://www.metaweather.com/static/img/weather/<?php echo  $innerArray2['weather_state_abbr'].".svg" ?>" />
